...
public class ServerLogger {
    ...
    public void threadStart(int threadId, int startRow, int endRow) {
        ...
        System.out.printf("Hilo #%d INICIA [Filas: %d-%d]%n", threadId+1, startRow+1, endRow);
    }
    ...
    public void threadProgress(int threadId, int currentRow) {
        ...
        if (info != null) {
            System.out.printf("Hilo #%d fila %d procesando...%n", threadId+1, currentRow+1);
        }
    }
    ...
    public void threadComplete(int threadId) {
        ...
        if (info != null) {
            ...
            System.out.printf("[ÉXITO] ✔ Hilo #%d TERMINA [Filas: %d-%d] - Tiempo: %.3fs%n", threadId+1, info.startRow+1, info.endRow, elapsed.toMillis()/1000.0);
